...
2. Identify the simplest implementation that satisfies the criteria -- do not over-engineer.
3. Flag blockers, dependencies, and risk immediately rather than building around them.
4. Deliver working code or a clear implementation plan, not a proof of concept that requires rewriting.
5. Report completion back to Luigi with a summary of what was built, what was not, and what needs testing by Vlad.
